        ...
        switch (currentTurn) {
            case 0 -> {//Balloon
                ...
                if (!bodyParts[1].isDead()) {
                    fightManager.sendShootData(index, (byte) 44, (short) Utils.getArgXY(x, y, player.getX(), player.getY()), (byte) 10, (byte) 0, (byte) 1);
                } else if (!bodyParts[2].isDead()) {
                    fightManager.sendShootData(index, (byte) 43, (short) 270, (byte) 20, (byte) 0, (byte) 1);
                }
            }
            ...
            //Gun Big
            case 2 -> fightManager.sendShootData(index, (byte) 43, (short) 270, (byte) 20, (byte) 0, (byte) 1);
            ...
            case 4 -> {
                ...
                fightManager.sendShootData(index, (byte) 45, (short) Utils.getArgXY(x, y, player.getX(), player.getY()), (byte) 20, (byte) 0, (byte) 1);
            }
        }
    }
