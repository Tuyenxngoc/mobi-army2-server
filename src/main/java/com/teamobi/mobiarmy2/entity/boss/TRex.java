...
public class TRex extends Boss {
    ...
    public void turnAction() {
        ...
        switch (Utils.nextInt(3)) {
            case 0 -> // T. rex rocket
                    fightManager.sendShootData(index, (byte) 37, (short) 110, (byte) 30, (byte) 0, (byte) 1);
            ...
            case 1 -> { // T. rex laser
                ...
                fightManager.sendShootData(index, (byte) 40, forceArgXY[0], (byte) forceArgXY[1], (byte) 0, (byte) 1);
            }
            ...
            default -> { // T. rex white
                ...
                fightManager.sendShootData(index, (byte) 41, forceArgXY[0], (byte) forceArgXY[1], (byte) 0, (byte) 1);
            }
        }
    }
}