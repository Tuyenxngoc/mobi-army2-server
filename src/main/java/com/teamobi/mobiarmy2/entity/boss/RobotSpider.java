...
public class RobotSpider extends Boss {
    ...
    public void turnAction() {
        ...
        if (distance < 30) {
            this.usedItemId = 9;
            fightManager.sendShootData(index, (byte) 8, (short) Utils.getArgXY(x, y, player.getX(), player.getY()), (byte) 30, (byte) 0, (byte) 1);
        ...
        switch (Utils.nextInt(3)) {
            case 0 -> {// Tơ nhện
                ...
                fightManager.sendShootData(index, (byte) 8, forceArgXY[0], (byte) forceArgXY[1], (byte) 0, (byte) 1);
                byte force = (byte) Utils.nextInt(15, 30);
                short arg = (short) Utils.nextInt(80, 100);
                fightManager.sendShootData(index, (byte) 36, arg, force, (byte) 0, (byte) 1);
            }
            case 1 -> {// Laser
                ...
                fightManager.sendShootData(index, (byte) 14, forceArgXY[0], (byte) forceArgXY[1], (byte) 0, (byte) 1);
            }
            case 2 -> {// Rocket
                short[] forceArgXY = fightManager.getForceArgXY(
                ...
                fightManager.sendShootData(index, (byte) 33, forceArgXY[0], (byte) forceArgXY[1], (byte) 0, (byte) 1);
            }
        }
    }
}
