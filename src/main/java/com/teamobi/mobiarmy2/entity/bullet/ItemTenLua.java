...
public class ItemTenLua extends Bullet {
    ...
    public void nextXY() {
        ...
        if (super.frame == this.force || this.collect) {
            this.bulletManager.addShoot(new Bullet(bulletManager, (byte) 27, super.damage, pl, this.X + 18, this.Y - 20, 2, -1, 15, 60));
            this.bulletManager.addShoot(new Bullet(bulletManager, (byte) 27, super.damage, pl, this.X + 17, this.Y - 20, -3, -1, 15, 60));
            this.bulletManager.addShoot(new Bullet(bulletManager, (byte) 27, super.damage, pl, this.X + 16, this.Y - 23, 3, -2, 15, 60));
        }
    }
}
