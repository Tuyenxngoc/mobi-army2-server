    ...
    public void turnAction() {
        try {
            ...
            if (((this.fightManager.players[this.part[1]].isDie && this.fightManager.players[this.part[2]].isDie) || this.fightManager.players[this.part[3]].isDie) && this.part[4] == -1) {
                ...
                this.fightManager.addBoss(new Balloon_Eye(this.fightManager, (byte) 21, "Balloon Eye", (byte) this.fightManager.allCount, 1500 + (this.fightManager.getLevelTeam() * 10), (short) (super.X + 55), (short) (super.Y - 27)));
            } else if (fd) {
            ...
            if (this.turns == 0) {
                if (!fd) {
                    short toX = (short) Utils.nextInt(100, this.fightManager.mapMNG.Width - 100);
                ...
                if (!this.fightManager.players[this.part[1]].isDie) {
                    this.fightManager.newShoot(this.index, (byte) 44, (short) Utils.getArgXY(X, Y, pl.X, pl.Y), (byte) 10, (byte) 0, (byte) 1);
                    return;
                }
            } else if (this.turns == 2 && !this.fightManager.players[this.part[2]].isDie) {
                this.fightManager.newShoot(this.index, (byte) 43, (short) 270, (byte) 20, (byte) 0, (byte) 1);
                return;
            } else if (this.turns == 4 && !this.fightManager.players[this.part[4]].isDie) {
                this.fightManager.newShoot(this.index, (byte) 45, (short) Utils.getArgXY(X, Y, pl.X, pl.Y), (byte) 20, (byte) 0, (byte) 1);
                return;
            }
