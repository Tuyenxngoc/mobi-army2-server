...
public class MGTBulletOld extends Bullet {
    ...
    public MGTBulletOld(BulletManager bullMNG, byte bullId, long satThuong, Player pl, int X, int Y, int vx100, int vy100, int force) {
    ...
    public void nextXY() {
        ...
        if (XYVC != null) {
            ...
            if (this.isCanCollision) {
                fightManager.mapManager.handleCollision((short) X, (short) Y, this);
            }
            return;
        }
        if (frame == force) {
