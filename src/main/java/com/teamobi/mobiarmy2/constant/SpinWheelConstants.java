...
public class SpinWheelConstants {
    ...
    public static final int[] XU_PROBABILITIES = {400, 300, 200, 100};

    public static final int[] XP_COUNTS = {1, 50, 100, 500};
    public static final int[] XP_PROBABILITIES = {400, 300, 200, 100};

    public static final int[] TYPE_PROBABILITIES = {300, 150, 450, 100};
}
