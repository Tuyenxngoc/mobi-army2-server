    ...
    public void turnAction() {
        try {
            ...
            if (Math.abs(X - pl.X) <= 40) {
                ...
                this.fightMNG.newShoot(this.index, (byte) 36, arg, force, (byte) 0, (byte) 1, false);
                return;
            }
            ...
            switch (Until.nextInt(9)) {
                case 0:
                    ...
                    this.fightMNG.newShoot(this.index, (byte) 0, FA[0], (byte) FA[1], (byte) 0, (byte) 1, false);
                    break;
                case 1:
                    ...
                    this.fightMNG.newShoot(this.index, (byte) 2, FA[0], (byte) FA[1], (byte) 0, (byte) 1, false);
                    break;
                case 2:
                    ...
                    this.fightMNG.newShoot(this.index, (byte) 10, FA[0], (byte) FA[1], (byte) 0, (byte) 1, false);
                    break;
                case 3:
                    this.itemUsed = 6;
                    ...
                    this.fightMNG.newShoot(this.index, (byte) 6, FA[0], (byte) FA[1], (byte) 0, (byte) 1, false);
                    break;
                case 4:
                    this.itemUsed = 7;
                    ...
                    this.fightMNG.newShoot(this.index, (byte) 7, FA[0], (byte) FA[1], (byte) 0, (byte) 1, false);
                    break;
                case 5:
                case 6:
                case 7:
                case 8:
                    ...
                    this.fightMNG.newShoot(this.index, (byte) 36, FA[0], (byte) FA[1], (byte) 0, (byte) 1, false);
                    break;
            }
        } catch (Exception e) {
            e.printStackTrace();
