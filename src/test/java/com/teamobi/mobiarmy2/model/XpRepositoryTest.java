...
class XpRepositoryTest {
    ...
    void setUp() {
        // Set up test data
        XpRepository.LEVEL_XP_REQUIRED_ENTRIES.clear(); // Clear existing data
        ...
        level1.setXp(400);
        XpRepository.LEVEL_XP_REQUIRED_ENTRIES.add(level1);
        XpRepository.LEVEL_XP_REQUIRED_ENTRIES.add(level2);
        XpRepository.LEVEL_XP_REQUIRED_ENTRIES.add(level3);
    }

    @Test
    void getLevelByEXP() {
        assertEquals(2, XpRepository.getLevelByEXP(200));
    }
}